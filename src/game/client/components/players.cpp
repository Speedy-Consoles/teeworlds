	...
	)
{
	...
	bool InAir = !(GetDDRTeamCollision(Player.m_WorldID)->GetCollisionMove(Player.m_X, Player.m_Y+16, Player.m_X, Player.m_Y+14, !m_pClient->IsDDRace())&CCollision::COLFLAG_SOLID);
